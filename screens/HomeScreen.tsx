...
export default function HomeScreen({
    ...
    useEffect(() => {
        ...
        backendFetch<User[]>('GET', 'company').then(companies => setCompanies(companies as User[])).catch();
        backendFetch<Flirt[]>('GET', 'flirts').then(flirts => setFlirts(flirts as Flirt[])).catch();
    }, [refresh]);
